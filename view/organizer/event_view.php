          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <a type="button" id="btnAddAction" href="index.php?action=org-event-add" class="btn btn-primary float-right"><i class="fas fa-plus"></i> Add New Event</a>
              </div>
              <!-- /.card-header -->
                  ...
                  <tbody>
                    ...
                    if (! empty($result)) {
                        foreach ($result as $k => $v) {
                          ...
                          ?>
                          <td>
                            <a class="btnViewAction" href="index.php?action=org-mission-view&id=<?php echo $result[$k]["id"]; ?>" )'>
                            <i class="fa fa-eye fa-fw" aria-hidden="true"></i></a>
                            <a class="btnEditAction" href="index.php?action=org-event-edit&id=<?php echo $result[$k]["id"]; ?>">
                            <i class="fa fa-edit fa-fw" aria-hidden="true"></i></a>
                            <a class="btnDeleteAction" onclick='confirmDel("index.php?action=org-event-delete&id=<?php echo $result[$k]["id"];?>&uid=<?=$_SESSION["uid"]?>" )'>
